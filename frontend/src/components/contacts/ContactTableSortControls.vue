<template>
  <div class="flex items-center gap-2">
    ...
    <select
      ...
      :disabled="disabled"
      :class="[
        'rounded-md px-3 py-2 font-sans border-0 bg-gray-200 dark:bg-slate-900 focus:outline-none text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400',
